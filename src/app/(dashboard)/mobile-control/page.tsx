              ...
              {activeTab === 'financial' && (
                <Card className="p-8 text-center">
                  <div className="max-w-md mx-auto">
                    ...
                    <h3 className="mt-2 text-sm font-medium text-gray-900">Financial Control Panel</h3>
                    <p className="mt-1 text-sm text-gray-500">
                      Coming soon - Control financial data, payment information, and credit accounts
                    </p>
                  </div>
                </Card>
              )}
              ...
              {activeTab === 'communication' && (
                <Card className="p-8 text-center">
                  <div className="max-w-md mx-auto">
                    ...
                    <h3 className="mt-2 text-sm font-medium text-gray-900">Communication Control Panel</h3>
                    <p className="mt-1 text-sm text-gray-500">
                      Coming soon - Control messages, notifications, and communication workflows
                    </p>
                  </div>
                </Card>
              )}
              ...
              {activeTab === 'team' && (
                <Card className="p-8 text-center">
                  <div className="max-w-md mx-auto">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Coming soon - Control contractor information, team assignments, and performance data
                    </p>
                  </div>
                </Card>
              )}
              ...
              {activeTab === 'materials' && (
                <Card className="p-8 text-center">
                  <div className="max-w-md mx-auto">
                    ...
                    <h3 className="mt-2 text-sm font-medium text-gray-900">Materials Control Panel</h3>
                    <p className="mt-1 text-sm text-gray-500">
                      Coming soon - Control material orders, deliveries, and supplier information
                    </p>
                  </div>
                </Card>
              )}
