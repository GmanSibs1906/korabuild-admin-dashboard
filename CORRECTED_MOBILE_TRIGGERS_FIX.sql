-- CORRECTED: Fix mobile notification triggers with proper notification_type values
-- This script fixes the ambiguous column references AND uses correct notification_type values

-- =========================================================================
-- FIX 1: NEW DELIVERIES NOTIFICATIONS TRIGGER (CORRECTED)
-- =========================================================================
...
-- =========================================================================
-- FIX 2: DELIVERY STATUS UPDATES NOTIFICATIONS TRIGGER (CORRECTED)
-- =========================================================================
...
-- =========================================================================
-- FIX 3: NEW ORDERS NOTIFICATIONS TRIGGER (CORRECTED)
-- =========================================================================
...
BEGIN
    ...
    IF project_owner_id IS NOT NULL THEN
        PERFORM create_mobile_notification(
            ...
            'order',    -- entity_type can be anything
            NEW.id,
            'normal',
            '/orders',
            jsonb_build_object(
...
-- =========================================================================
-- FIX 4: ORDER STATUS UPDATES NOTIFICATIONS TRIGGER (CORRECTED)
-- =========================================================================
...
SELECT 'Mobile notification triggers CORRECTED successfully - delivery creation should now work!' as status; 